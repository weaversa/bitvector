...
extern bitvector_t *bitvector_t_fromHexString(char *string, size_t length);
...
extern void bitvector_from_bytesUpdate(bitvector_t *bv, uint8_t *bytes, size_t nBytes);
extern bitvector_t *bitvector_from_bytes(uint8_t *bytes, size_t nBytes);
